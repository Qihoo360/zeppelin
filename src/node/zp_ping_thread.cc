...
pink::Status ZPPingThread::Send() {
 ...
 // std::string wbuf_str;
 // if (!is_first_send_) {
 //   ZPDataControl::Ping_Request request;
 //   ZPDataControl::Node* node = request.mutable_node();
 ...
 //   cli_->set_opcode(ZPDataControl::OPCODE::PING);
 //   return cli_->Send(&request);
 // } else {
 //   ZPDataControl::Join_Request request;
 //   ZPDataControl::Node* node = request.mutable_node();
 //   node->set_ip(zp_data_server->local_ip());
 //   node->set_port(zp_data_server->local_port());
 ...
 //   cli_->set_opcode(ZPDataControl::OPCODE::JOIN);
...
//
//  switch (opcode) {
//    case ZPDataControl::OPCODE::JOIN: {
//      ZPDataControl::Join_Response response;
...
//      break;
//    }
//    case ZPDataControl::OPCODE::PING: {
//      ZPDataControl::Ping_Response response;
//      result = cli_->Recv(&response); 
